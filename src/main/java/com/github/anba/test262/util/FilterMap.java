...
/**
 * Applies the standard {@code filter} and {@code map} list operations on
 * {@link Iterable}s to form a simple list comprehension:
 * 
 * <pre>
...
public abstract class FilterMap<T, U> implements Iterable<U> {
    ...
    /**
     * If {@code filter()} returns {@code true}, the value will be included in
     * the final result. Otherwise it will be omitted.
     */
